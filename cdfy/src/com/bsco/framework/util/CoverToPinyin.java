...
//		private static CoverToPinyin characterParser = new CoverToPinyin();
//
//		public static CoverToPinyin getInstance() {
...
//			CoverToPinyin parser = CoverToPinyin.getInstance();
			System.out.println(CoverToPinyin.getSelling("单田芳"));
		}
