 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'web/js/zDialog/images/'; //图片路径配置
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" value="确 定" style="background:#F5F5F5; border:#ccc 1px solid;width:40px; height:20px;"  id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" value="取 消" style="background:#F5F5F5; border:#ccc 1px solid;width:40px; height:20px;"  onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
