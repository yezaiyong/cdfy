    ...
    a.fn.smartWizard = function(k) {
        ...
        return this.each(function() {
            function z() {
                ...
                p = a("<a>" + c.labelFinish + "</a>").attr("href", "#").addClass("");
                c.errorSteps && c.errorSteps.length > 0 && a.each(c.errorSteps,
                function(a, b) {
                    v(b, !0)
                });
                m.append(d);
...
//                    return ! 1
            ...
            function t(d) {
                ...
                if (c.transitionEffect == "slide") a(a(g, b).attr("href"), b).slideUp("fast",
                function() {
                    a(a(e, b).attr("href"), b).slideDown("fast");
                    h = d;
                    r(g, e)
                });
                else if (c.transitionEffect == "fade") a(a(g, b).attr("href"), b).fadeOut("fast",
                function() {
            ...
            function r(d, e) {
                ...
                a(e, b).attr("isDone", 1);
                c.cycleSteps || (0 >= h ? a(o).addClass("buttonDisabled") : a(o).removeClass("buttonDisabled"), f.length - 1 <= h ? a(n).addClass("buttonDisabled") : a(n).removeClass("buttonDisabled")); ! f.hasClass("disabled") || c.enableFinishButton ? a(p).removeClass("buttonDisabled") : a(p).addClass("buttonDisabled");
            ...
            if (!k || k === "init" || typeof k === "object") z();
                ...
                B(s[0]);
                return ! 0
            } else if (k === "setError") return s = Array.prototype.slice.call(u, 1),
