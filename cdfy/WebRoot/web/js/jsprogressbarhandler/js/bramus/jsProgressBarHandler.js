  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: 'web/js/jsprogressbarhandler/images/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: 'web/js/jsprogressbarhandler/images/bramus/percentImage_back1.png',	// Image to use in the progressbar. Can be an array of images too.
